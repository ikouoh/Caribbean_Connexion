 ...
 */
class Ile extends \Entity\Ile implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'ile', 'descriptif', 'image', 'vues', 'actif');
    }
